{{ config(
  ...
  post_hook = "ALTER TABLE {{ this }} ADD SEARCH OPTIMIZATION ON EQUALITY(tx_hash, contract_address, pool_address, pool_name, tokens, symbols), SUBSTRING(tx_hash, contract_address, pool_address, pool_name, tokens, symbols)",
