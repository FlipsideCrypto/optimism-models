...
agg_sales_prices AS (
    SELECT
        ...
        s.currency_address,
        CASE
            WHEN s.currency_address = 'ETH' THEN s.price / n.nft_count
        ...
        CASE
            WHEN s.currency_address = 'ETH' THEN total_fees / n.nft_count
            WHEN s.currency_address != 'ETH'
        ...
        CASE
            WHEN s.currency_address = 'ETH' THEN platform_fee / n.nft_count
            WHEN s.currency_address != 'ETH'
        ...
        CASE
            WHEN s.currency_address = 'ETH' THEN creator_fee / n.nft_count
            WHEN s.currency_address != 'ETH'
